...
<div class="mb-6 flex items-center gap-4">
    ...
    <div>
        ...
        <p class="text-gray-600 text-sm mt-1">Tambahkan data barang baru ke dalam katalog.</p>
    </div>
</div>
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="5" 
                        class="block w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 sm:text-sm transition-all @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
            ...
            <div class="space-y-6">
                    ...
                    <div id="variants-container" class="space-y-3">
                        ...
                        <div class="variant-row flex gap-3 items-start bg-white p-3 rounded-lg border border-gray-100 shadow-sm relative">
                            <div class="flex-1">
                                ...
                                <input type="text" name="variants[0][unit]" required placeholder="Cth: 1 Kg" 
                            ...
                            <div class="flex-1">
                                ...
                                <input type="number" name="variants[0][price]" required min="0" placeholder="5000"
                                    class="block w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-md focus:ring-1 focus:ring-teal-500 text-sm">
                            </div>
                            <div class="w-20">
                                <label class="block text-xs font-medium text-gray-500 mb-1">Stok</label>
                                <input type="number" name="variants[0][stock]" required min="0" value="0"
                                    class="block w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-md focus:ring-1 focus:ring-teal-500 text-sm">
                            </div>
                            <button type="button" class="remove-variant-btn mt-6 text-red-500 hover:bg-red-50 p-1.5 rounded disabled:opacity-50" disabled>
                ...
                <!-- Image -->
                <div>
                    <label for="image" class="block text-sm font-medium text-gray-700 mb-1">Gambar Produk <span class="text-red-500">*</span></label>
                    ...
                    <p class="mt-1.5 text-xs text-gray-500">Format: JPG, PNG, JPEG. Maks 2MB.</p>
