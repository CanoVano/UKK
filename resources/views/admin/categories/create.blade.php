...
<div class="mb-6 flex items-center gap-4">
    ...
    <div>
        ...
        <p class="text-gray-600 text-sm mt-1">Buat kategori baru untuk mengelompokkan produk.</p>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 max-w-2xl">
    <form action="{{ route('admin.categories.store') }}" method="POST" class="p-6 space-y-6">
        ...
        <div>
            ...
            @enderror
            <p class="mt-1.5 text-xs text-gray-500">Slug akan di-generate otomatis dari nama kategori.</p>
        </div>
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="4" 
                class="block w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 sm:text-sm transition-all @error('description') border-red-500 focus:ring-red-500 @enderror" 
